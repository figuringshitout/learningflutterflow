...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    learnFlutterflowAuthUserSubject.add(
      LearnFlutterflowAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LearnFlutterflowAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LearnFlutterflowAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LearnFlutterflowAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    learnFlutterflowAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
LearnFlutterflowAuthUser? currentUser;
